...
import { hiragana } from "@/lib/data/kana";
...
export default function LearningHiraganaPage() {
  return (
    <div className="flex h-screen w-full flex-col bg-background">
      ...
      <main className="flex-1 space-y-6 overflow-y-auto p-6">
        <KanaTable title="Gojuon (Vokal Dasar)" kanaList={hiragana.gojuon} />
        <KanaTable title="Dakuon" kanaList={hiragana.dakuon} />
        <KanaTable title="Handakuon" kanaList={hiragana.handakuon} />
        <KanaTable title="Youon" kanaList={hiragana.youon} />
      </main>
    </div>
  );
}
