...
const kanaTypes: KanaType[] = [
  { id: 'gojuon', title: 'Gojuon (Vokal Dasar)', description: 'Karakter dasar dalam Hiragana.' },
  ...
  { id: 'youon', title: 'Youon', description: 'Karakter gabungan dengan や, ゆ, よ kecil.' },
];


export default function HiraganaLearningSelectionPage() {
  return (
    <div className="flex h-screen w-full flex-col bg-background">
      ...
      <main className="flex-1 overflow-y-auto p-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {kanaTypes.map((type) => (
             <Link key={type.id} href={`/hiragana/learning/${type.id}`} passHref>
