    ...
    <SidebarProvider>
      ...
      <SidebarInset>
        <header className="sticky top-0 z-10 flex h-16 items-center justify-between border-b bg-background/80 px-6 backdrop-blur-sm">
          <SidebarTrigger />
          <h1 className="font-headline text-2xl font-semibold">Hiragana</h1>
          <DropdownMenu>
          ...
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            <Card className="flex transform flex-col justify-between transition-transform duration-300 hover:scale-105 hover:shadow-xl">
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <CardTitle>Learning Hiragana</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="mb-4 text-muted-foreground">
                  Mulai perjalanan Anda dengan mempelajari karakter Hiragana.
                </p>
            ...
            <Card className="flex transform flex-col justify-between transition-transform duration-300 hover:scale-105 hover:shadow-xl">
              ...
              <CardContent>
                ...
                <Link href="/hiragana/reading" passHref>
            ...
            <Card className="flex transform flex-col justify-between transition-transform duration-300 hover:scale-105 hover:shadow-xl">
              <CardHeader>
                <div className="flex items-center gap-4">
                  ...
                  <CardTitle>Hiragana Practice</CardTitle>
                </div>
              </CardHeader>
              <CardContent>
                <p className="mb-4 text-muted-foreground">
                  Uji dan perkuat pemahaman Hiragana Anda melalui latihan interaktif.
                </p>
                <Link href="/hiragana/practice" passHref>
